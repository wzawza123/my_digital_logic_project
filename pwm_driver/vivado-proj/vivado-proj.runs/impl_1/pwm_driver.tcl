...
set rc [catch {
  ...
  catch { write_mem_info -force pwm_driver.mmi }
  write_bitstream -force pwm_driver.bit 
  catch { write_sysdef -hwdef pwm_driver.hwdef -bitfile pwm_driver.bit -meminfo pwm_driver.mmi -file pwm_driver.sysdef }
